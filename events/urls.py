...
urlpatterns = [
    ...
    path('ticketmaster_event/<str:ticketmaster_event_id>/', views.ticketmaster_event_detail,
         name='ticketmaster_event_detail'),
    path('ticketmaster_event/<str:ticketmaster_event_id>/add_to_cart/', views.add_to_cart_ticketmaster,
         name='add_to_cart_ticketmaster'),
